# Comparing `tmp/stopwords_tr-1.1.5.tar.gz` & `tmp/stopwords_tr-1.1.6.tar.gz`
...
## Comparing `stopwords_tr-1.1.5.tar` & `stopwords_tr-1.1.6.tar`
...
### Comparing `stopwords_tr-1.1.5/LICENSE` & `stopwords_tr-1.1.6/LICENSE`

 * *Files identical despite different names*

### Comparing `stopwords_tr-1.1.5/PKG-INFO` & `stopwords_tr-1.1.6/PKG-INFO`
...
### Comparing `stopwords_tr-1.1.5/setup.py` & `stopwords_tr-1.1.6/setup.py`
...
### Comparing `stopwords_tr-1.1.5/src/stopwords_tr/stopwords_tr.egg-info/PKG-INFO` & `stopwords_tr-1.1.6/src/stopwords_tr.egg-info/PKG-INFO`
