# Comparing `tmp/stopwords_tr-1.1.7.tar.gz` & `tmp/stopwords_tr-1.1.8.tar.gz`
...
## Comparing `stopwords_tr-1.1.7.tar` & `stopwords_tr-1.1.8.tar`
...
### Comparing `stopwords_tr-1.1.7/LICENSE` & `stopwords_tr-1.1.8/LICENSE`

 * *Files identical despite different names*

### Comparing `stopwords_tr-1.1.7/PKG-INFO` & `stopwords_tr-1.1.8/PKG-INFO`
...
### Comparing `stopwords_tr-1.1.7/setup.py` & `stopwords_tr-1.1.8/setup.py`
...
### Comparing `stopwords_tr-1.1.7/src/stopwords_tr.egg-info/PKG-INFO` & `stopwords_tr-1.1.8/src/stopwords_tr.egg-info/PKG-INFO`
