# Comparing `tmp/zato_apitest-24.1.32.tar.gz` & `tmp/zato_apitest-24.1.33.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "zato_apitest-24.1.32.tar", last modified: Tue Apr 30 10:45:22 2024, max compression
+gzip compressed data, was "zato_apitest-24.1.33.tar", last modified: Tue Apr 30 11:24:42 2024, max compression
```

## Comparing `zato_apitest-24.1.32.tar` & `zato_apitest-24.1.33.tar`

### file list

```diff
@@ -1,32 +1,32 @@
-drwxrwxr-x   0 dsuch     (1000) dsuch     (1000)        0 2024-04-30 10:45:22.814120 zato_apitest-24.1.32/
--rw-r--r--   0 dsuch     (1000) dsuch     (1000)    29450 2024-04-28 07:49:48.000000 zato_apitest-24.1.32/LICENSE.txt
--rw-r--r--   0 dsuch     (1000) dsuch     (1000)       24 2019-06-24 21:01:23.000000 zato_apitest-24.1.32/MANIFEST.in
--rw-r--r--   0 dsuch     (1000) dsuch     (1000)     2341 2024-04-30 10:45:22.814120 zato_apitest-24.1.32/PKG-INFO
--rw-r--r--   0 dsuch     (1000) dsuch     (1000)       64 2021-01-13 02:20:20.000000 zato_apitest-24.1.32/README.md
--rw-r--r--   0 dsuch     (1000) dsuch     (1000)      375 2024-03-12 11:30:46.000000 zato_apitest-24.1.32/requirements.txt
--rw-rw-r--   0 dsuch     (1000) dsuch     (1000)       38 2024-04-30 10:45:22.814120 zato_apitest-24.1.32/setup.cfg
--rw-rw-r--   0 dsuch     (1000) dsuch     (1000)     2612 2024-04-30 10:44:19.000000 zato_apitest-24.1.32/setup.py
-drwxrwxr-x   0 dsuch     (1000) dsuch     (1000)        0 2024-04-30 10:45:22.810120 zato_apitest-24.1.32/src/
-drwxrwxr-x   0 dsuch     (1000) dsuch     (1000)        0 2024-04-30 10:45:22.810120 zato_apitest-24.1.32/src/zato/
--rw-r--r--   0 dsuch     (1000) dsuch     (1000)      211 2024-04-28 07:50:38.000000 zato_apitest-24.1.32/src/zato/__init__.py
-drwxrwxr-x   0 dsuch     (1000) dsuch     (1000)        0 2024-04-30 10:45:22.810120 zato_apitest-24.1.32/src/zato/apitest/
--rw-r--r--   0 dsuch     (1000) dsuch     (1000)     1800 2024-04-28 07:51:00.000000 zato_apitest-24.1.32/src/zato/apitest/__init__.py
--rw-r--r--   0 dsuch     (1000) dsuch     (1000)     4481 2024-04-30 10:04:25.000000 zato_apitest-24.1.32/src/zato/apitest/cli.py
-drwxrwxr-x   0 dsuch     (1000) dsuch     (1000)        0 2024-04-30 10:45:22.810120 zato_apitest-24.1.32/src/zato/apitest/console/
--rw-r--r--   0 dsuch     (1000) dsuch     (1000)      210 2024-04-28 07:50:47.000000 zato_apitest-24.1.32/src/zato/apitest/console/apitest
--rw-r--r--   0 dsuch     (1000) dsuch     (1000)     6434 2024-04-29 09:17:00.000000 zato_apitest-24.1.32/src/zato/apitest/init.py
--rw-r--r--   0 dsuch     (1000) dsuch     (1000)     4828 2024-04-30 10:43:24.000000 zato_apitest-24.1.32/src/zato/apitest/run.py
-drwxrwxr-x   0 dsuch     (1000) dsuch     (1000)        0 2024-04-30 10:45:22.814120 zato_apitest-24.1.32/src/zato/apitest/steps/
--rw-r--r--   0 dsuch     (1000) dsuch     (1000)      156 2024-04-28 07:50:55.000000 zato_apitest-24.1.32/src/zato/apitest/steps/__init__.py
--rw-rw-r--   0 dsuch     (1000) dsuch     (1000)    48261 2024-04-30 07:45:23.000000 zato_apitest-24.1.32/src/zato/apitest/steps/common.py
--rw-r--r--   0 dsuch     (1000) dsuch     (1000)    22517 2024-04-28 07:50:58.000000 zato_apitest-24.1.32/src/zato/apitest/steps/json.py
--rw-rw-r--   0 dsuch     (1000) dsuch     (1000)     7325 2024-04-28 07:50:53.000000 zato_apitest-24.1.32/src/zato/apitest/typing_.py
--rw-r--r--   0 dsuch     (1000) dsuch     (1000)    14680 2024-04-29 09:23:45.000000 zato_apitest-24.1.32/src/zato/apitest/util.py
-drwxrwxr-x   0 dsuch     (1000) dsuch     (1000)        0 2024-04-30 10:45:22.814120 zato_apitest-24.1.32/src/zato_apitest.egg-info/
--rw-r--r--   0 dsuch     (1000) dsuch     (1000)     2341 2024-04-30 10:45:22.000000 zato_apitest-24.1.32/src/zato_apitest.egg-info/PKG-INFO
--rw-rw-r--   0 dsuch     (1000) dsuch     (1000)      654 2024-04-30 10:45:22.000000 zato_apitest-24.1.32/src/zato_apitest.egg-info/SOURCES.txt
--rw-rw-r--   0 dsuch     (1000) dsuch     (1000)        1 2024-04-30 10:45:22.000000 zato_apitest-24.1.32/src/zato_apitest.egg-info/dependency_links.txt
--rw-rw-r--   0 dsuch     (1000) dsuch     (1000)        5 2024-04-30 10:45:22.000000 zato_apitest-24.1.32/src/zato_apitest.egg-info/namespace_packages.txt
--rw-rw-r--   0 dsuch     (1000) dsuch     (1000)        1 2024-04-30 10:45:20.000000 zato_apitest-24.1.32/src/zato_apitest.egg-info/not-zip-safe
--rw-rw-r--   0 dsuch     (1000) dsuch     (1000)      356 2024-04-30 10:45:22.000000 zato_apitest-24.1.32/src/zato_apitest.egg-info/requires.txt
--rw-rw-r--   0 dsuch     (1000) dsuch     (1000)        5 2024-04-30 10:45:22.000000 zato_apitest-24.1.32/src/zato_apitest.egg-info/top_level.txt
...
### Comparing `zato_apitest-24.1.32/LICENSE.txt` & `zato_apitest-24.1.33/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `zato_apitest-24.1.32/PKG-INFO` & `zato_apitest-24.1.33/PKG-INFO`
...
```diff
@@ -1,8 +1,8 @@
-Metadata-Version: 2.1 Name: zato-apitest Version: 24.1.32 Summary: API Testing
...
### Comparing `zato_apitest-24.1.32/setup.py` & `zato_apitest-24.1.33/setup.py`
...
-'24.1.32' LONG_DESCRIPTION = """ Write API tests for your [API integrations]
...
### Comparing `zato_apitest-24.1.32/src/zato/apitest/__init__.py` & `zato_apitest-24.1.33/src/zato/apitest/__init__.py`

 * *Files identical despite different names*

### Comparing `zato_apitest-24.1.32/src/zato/apitest/cli.py` & `zato_apitest-24.1.33/src/zato/apitest/cli.py`

 * *Files identical despite different names*

### Comparing `zato_apitest-24.1.32/src/zato/apitest/init.py` & `zato_apitest-24.1.33/src/zato/apitest/init.py`

 * *Files identical despite different names*

### Comparing `zato_apitest-24.1.32/src/zato/apitest/run.py` & `zato_apitest-24.1.33/src/zato/apitest/run.py`

 * *Files identical despite different names*

### Comparing `zato_apitest-24.1.32/src/zato/apitest/steps/common.py` & `zato_apitest-24.1.33/src/zato/apitest/steps/common.py`
...
@@ -142,15 +142,15 @@
     ...
     if is_verbose:
-        util.log_http_response1(logger, response.content)
...
@@ -279,15 +279,15 @@
     ...
     if is_verbose:
-        util.log_http_response1(logger, ctx.zato.response.data.content)
...
### Comparing `zato_apitest-24.1.32/src/zato/apitest/steps/json.py` & `zato_apitest-24.1.33/src/zato/apitest/steps/json.py`

 * *Files identical despite different names*

### Comparing `zato_apitest-24.1.32/src/zato/apitest/typing_.py` & `zato_apitest-24.1.33/src/zato/apitest/typing_.py`

 * *Files identical despite different names*

### Comparing `zato_apitest-24.1.32/src/zato/apitest/util.py` & `zato_apitest-24.1.33/src/zato/apitest/util.py`
...
-def log_http_response1(logger:'Logger', content:'any_') -> 'any_':
...
### Comparing `zato_apitest-24.1.32/src/zato_apitest.egg-info/PKG-INFO` & `zato_apitest-24.1.33/src/zato_apitest.egg-info/PKG-INFO`
...
### Comparing `zato_apitest-24.1.32/src/zato_apitest.egg-info/SOURCES.txt` & `zato_apitest-24.1.33/src/zato_apitest.egg-info/SOURCES.txt`
