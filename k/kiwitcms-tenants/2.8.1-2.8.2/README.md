# Comparing `tmp/kiwitcms-tenants-2.8.1.tar.gz` & `tmp/kiwitcms-tenants-2.8.2.tar.gz`
...
### Comparing `kiwitcms-tenants-2.8.1/tcms_tenants/tests/__init__.py` & `kiwitcms-tenants-2.8.2/tcms_tenants/tests/__init__.py`
