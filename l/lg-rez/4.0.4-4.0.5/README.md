# Comparing `tmp/lg_rez-4.0.4.tar.gz` & `tmp/lg_rez-4.0.5.tar.gz`
...
### Comparing `lg_rez-4.0.4/README.md` & `lg_rez-4.0.5/README.md`
...
### Comparing `lg_rez-4.0.4/lgrez/features/chans.py` & `lg_rez-4.0.5/lgrez/features/chans.py`
