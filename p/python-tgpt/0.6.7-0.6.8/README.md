# Comparing `tmp/python_tgpt-0.6.7.tar.gz` & `tmp/python_tgpt-0.6.8.tar.gz`
...
### Comparing `python_tgpt-0.6.7/src/pytgpt/poe/main.py` & `python_tgpt-0.6.8/src/pytgpt/poe/main.py`
