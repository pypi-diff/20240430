# Comparing `tmp/assertai_alpha_deployer-3.0.tar.gz` & `tmp/assertai_alpha_deployer-4.0.tar.gz`
...
## Comparing `assertai_alpha_deployer-3.0.tar` & `assertai_alpha_deployer-4.0.tar`
...
### Comparing `assertai_alpha_deployer-3.0/PKG-INFO` & `assertai_alpha_deployer-4.0/PKG-INFO`
...
### Comparing `assertai_alpha_deployer-3.0/assertai_alpha_deployer.egg-info/PKG-INFO` & `assertai_alpha_deployer-4.0/assertai_alpha_deployer.egg-info/PKG-INFO`
...
### Comparing `assertai_alpha_deployer-3.0/setup.py` & `assertai_alpha_deployer-4.0/setup.py`
